...
/// - 400-499: stealth-address related failures
/// - 500-599: replay protection and signature validation
/// - 600-699: oracle aggregation and pricing failures
...
pub enum QuickexError {
    ...
    /// the ledger after its TTL expired. Call `restore_archived_escrow` once the
    /// entry has been restored on-chain, then retry the operation.
    EscrowArchived = 323,
